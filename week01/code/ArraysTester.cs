public static class ArraysTester
{
    ...
    private static double[] MultiplesOf(double number, int length)
    {
        ...
        //  Use a loop to populate the array with multiples of the number
        for (int i = 0; i < length; i++)
        {
            // Start with the initial number and multiply it by the loop index to generate each multiple
            result[i] = number * (i + 1);
        }
        // return the array
